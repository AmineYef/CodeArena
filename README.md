...
Le professeur crée un contest de 30 minutes avec 3 problèmes de difficulté moyenne
Les étudiants se connectent et entrent leur nom d'utilisateur
Chaque étudiant choisit un problème et soumet sa solution
Le système compile et exécute le code automatiquement
Le verdict apparaît instantanément (OK, WRONG_ANSWER, etc.)
Le leaderboard se met à jour après chaque soumission
À la fin du timer, le classement final est affiché
